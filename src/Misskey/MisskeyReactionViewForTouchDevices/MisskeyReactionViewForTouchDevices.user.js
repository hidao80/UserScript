...
const DEBUG = false;
const SCRIPT_NAME = 'Misskey reaction view for Touch devices';
            ...
            if (elem?.querySelector('button.button.reactions-view.hidao80-userscript') == null) {
                ...
                if (elem.querySelector('.mk-reactions-viewer')?.innerHTML.length) {
                    ...
                    button.addEventListener('click', e => {
                        ...
                        DEBUG && console.debug(reactionsDiv?.tagName.toLowerCase());
                        if (reactionsDiv?.tagName.toLowerCase() == 'div' ) {
                            DEBUG && console.debug("REMOVE!");
                            reactionsDiv.remove();
                            return;
                        }
                        ...
                        // DEBUG && console.debug(token, noteId, body);
